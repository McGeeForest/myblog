...
public class UsernamePasswordLoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public UsernamePasswordLoginSuccessHandler(JwtTokenManager tokenManager) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Authentication authentication) throws IOException, ServletException {
        ...
        logger.info(user.getUsername()+" 通过 username 登录成功，发放token于cookie："+message.toJsonString());
    }
}
